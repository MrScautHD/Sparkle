...
public class TestGui : Gui {
    ...
    protected override void Init() {
        ...
        this.AddElement("Text-Box-Button", new TextureTextBoxElement(textBoxData, textBoxLabelData, hintTextBoxLabelData, Anchor.Center, new Vector2(0, -60), 160, TextAlignment.Left, (12, 12), rotation: 0, clickFunc: () => {
            Logger.Error("BOX1!");
            return true;
        }));
