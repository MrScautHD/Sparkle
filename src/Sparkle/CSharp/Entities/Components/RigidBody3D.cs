...
public class RigidBody3D : Component {
    ...
    /// <summary>
    /// Applies an impulse to the rigid body in the specified direction.
    /// </summary>
    /// <param name="impulse">The vector representing the impulse to be applied to the rigid body.</param>
    /// <param name="wakeup">Determines whether the rigid body should be woken up if it is asleep. Default is true.</param>
    [Obsolete("Use ApplyImpulse instead.")]
    public void AddImpulse(Vector3 impulse, bool wakeup = true) {
        this.Body.AddImpulse(impulse, wakeup);
    }
    
    /// <summary>
    /// Applies an impulse to the rigid body at a specified position, modifying its velocity and/or angular velocity.
    /// </summary>
    /// <param name="impulse">The linear impulse vector to apply to the rigid body.</param>
    /// <param name="position">The world-space position where the impulse is applied. This position determines the torque (if any) generated by the impulse.</param>
    /// <param name="wakeup">Indicates whether the rigid body should be woken up if it is inactive. Defaults to true.</param>
    [Obsolete("Use ApplyImpulse instead.")]
    public void AddImpulse(Vector3 impulse, Vector3 position, bool wakeup = true) {
        this.Body.AddImpulse(impulse, position, wakeup);
    }
    ...
    private void CreateBody() {
        ...
        this.Position = this.Entity.WorldTransform.Translation;
        this.Orientation = this.Entity.WorldTransform.Rotation;
    }
