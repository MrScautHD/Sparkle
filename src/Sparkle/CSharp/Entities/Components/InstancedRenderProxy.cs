...
public class InstancedRenderProxy : InterpolatedComponent {
    ...
    public InstancedRenderProxy(MultiInstanceRenderer multiInstanceRenderer, Vector3 offsetPosition, bool frustumCulling = true, bool drawBox = false, Color? boxColor = null) : base(offsetPosition) {
