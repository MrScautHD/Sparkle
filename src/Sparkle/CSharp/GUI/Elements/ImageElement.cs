    ...
    protected internal override void Draw(GuiRenderQueue renderQueue) {
        ...
        switch (this.Data.ResizeMode) {
            case ResizeMode.None:
                this.DrawNormal(renderQueue, this.Data.Texture, this.Data.Sampler, this.Data.SourceRect, color, this.Data.Flip, this.Data.PixelSnap, this.Data.Effect, this.Data.BlendState);
                break;
            
            case ResizeMode.NineSlice:
            case ResizeMode.TileCenter:
                this.DrawNineSlice(renderQueue, this.Data.Texture, this.Data.Sampler, this.Data.SourceRect, this.Data.BorderInsets, this.Data.ResizeMode == ResizeMode.TileCenter, color, this.Data.Flip, this.Data.PixelSnap, this.Data.Effect, this.Data.BlendState);
                break;
        }
    }
