...
public static class MaterialHelper {
    ...
    public static Raylib_cs.Material LoadDefault() => Raylib.LoadMaterialDefault();
    
    /// <inheritdoc cref="Raylib.LoadMaterials"/>
    public static unsafe Raylib_cs.Material* LoadMaterials(sbyte* fileName, int* materialCount) => Raylib.LoadMaterials(fileName, materialCount);
    
    /// <inheritdoc cref="Raylib.IsMaterialReady"/>
    public static bool IsReady(Raylib_cs.Material material) => Raylib.IsMaterialReady(material);
    
    /// <inheritdoc cref="Raylib.UnloadMaterial"/>
    public static void Unload(Raylib_cs.Material material) => Raylib.UnloadMaterial(material);

    
    /// <inheritdoc cref="Raylib.GetMaterialTexture"/>
    public static Texture2D GetTexture(ref Raylib_cs.Model model, int materialIndex, MaterialMapIndex mapIndex) => Raylib.GetMaterialTexture(ref model, materialIndex, mapIndex);
    
    /// <inheritdoc cref="Raylib.SetMaterialShader"/>
    public static void SetShader(ref Raylib_cs.Model model, int materialIndex, ref Shader shader) => Raylib.SetMaterialShader(ref model, materialIndex, ref shader);
    
    /// <inheritdoc cref="Raylib.SetMaterialTexture(ref Material, MaterialMapIndex, Texture2D)"/>
    public static void SetTexture(ref Raylib_cs.Material material, MaterialMapIndex mapType, Texture2D texture) => Raylib.SetMaterialTexture(ref material, mapType, texture);
    
    /// <inheritdoc cref="Raylib.SetMaterialTexture(ref Model, int, MaterialMapIndex, ref Texture2D)"/>
    public static void SetTexture(ref Raylib_cs.Model model, int materialIndex, MaterialMapIndex mapIndex, ref Texture2D texture) => Raylib.SetMaterialTexture(ref model, materialIndex, mapIndex, ref texture);
    ...
    public static unsafe void SetColor(ref Raylib_cs.Material material, MaterialMapIndex mapIndex, Color color) {
    ...
    public static unsafe void SetColor(ref Raylib_cs.Model model, int materialIndex, MaterialMapIndex mapIndex, Color color) {
    ...
    public static unsafe void SetValue(ref Raylib_cs.Material material, MaterialMapIndex mapIndex, float value) {
    ...
    public static unsafe void SetValue(ref Raylib_cs.Model model, int materialIndex, MaterialMapIndex mapIndex, float value) {
